...
export default function () {
  ...
  const [totalBridge, setTotalBridge] = useState( resultBridgeLevelNFT(userNFTAvalanchefuji,userNFTFantom,userNFTPolygon).totalBridge)
  const [nftLevel1, setNftLevel1] = useState( resultBridgeLevelNFT(userNFTAvalanchefuji,userNFTFantom,userNFTPolygon).nftLevel1)
  const [nftLevel2, setNftLevel2] = useState( resultBridgeLevelNFT(userNFTAvalanchefuji,userNFTFantom,userNFTPolygon).nftLevel2)


  useEffect(() => {
   const result = resultBridgeLevelNFT(userNFTAvalanchefuji,userNFTFantom,userNFTPolygon)
